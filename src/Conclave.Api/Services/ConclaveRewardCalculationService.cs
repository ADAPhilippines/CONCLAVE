...
public class ConclaveRewardCalculationService : IConclaveRewardCalculationService
{
    ...
    public ConclaveRewardCalculationService(
    ...
    public ConclaveEpochDelegatorReward? CalculateConclaveTokenShare(
        double totalReward, 
        ConclaveEpochDelegatorReward conclaveDelegatorReward)
    {
    ...
    public ConclaveEpochDelegatorReward? CalculateRewardSharePercentage(
        ulong totalDelegated, 
